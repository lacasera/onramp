...
<div class="w-full bg-white">
    <div class="text-left bg-indigo-lightest">
        <div class="pt-16 pr-10 pb-20 pl-5">
            <h1 class="text-2xl leading-none font-bold">
                {{ __('Providing an easy entrance to Laravel for new developers') }}
            </h1>

            <a class="inline-block text-white font-semibold leading-tight hover:no-underline bg-indigo-darker rounded px-6 py-3 mt-6"
                href="#">Learn more</a>
        </div>
    </div>
    ...
    <div>
        <div class="container max-w-4xl mx-auto md:flex items-start py-12 px-6 md:px-0">
            <div class="w-full md:pr-12 mb-6">
                <h2 class="font-bold text-xl md:text-2xl">
                    What is this?
                </h2>

                <p class="leading-normal mb-4 mt-8">
    ...
    <div class="bg-indigo-darker text-white pb-20 pt-10 lg:pt-36 lg:pb-40">
        <div class="container mx-auto px-5 lg:px-12">
            ...
            <h2 class="text-2xl font-bold leading-none mt-10 lg:text-5xl lg:mt-20">
                Let's do it!
            </h2>

            <a class="inline-block text-indigo-darker font-semibold leading-tight hover:no-underline bg-white rounded px-6 py-3 mt-6"
